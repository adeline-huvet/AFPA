...
- Tâche à accomplir :
    - [-] Afficher les films dans un tableau **Utilisation de <div> avec <ul>**
    ...
    - [+] Si le formulaire est valide ajouter le film dans le tableau
        ...
        -[-] Afficher un message d'alerte pendant 3s : "Film ajouter avec succès" **Alert à la place d'une pop-up**
    - [+] Sinon on affichera un message d'erreur
        - [-] Afficher un message d'alerte pandant 3s : "Erreur dans le formulaire " + zone d'erreur **Alert à la place d'une pop-up**
    - [+] Pour le filtre :
        - [+] Si l'option filtre par titre est sélection on affichera les films par ordre alphabétique
        - [+/-] Si l'option filtre par année est sélection on affichera les films par ordre croissant **Décroissant**
